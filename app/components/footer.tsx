...
export default function Footer() {
  ...
  return (
    <>
      ...
      <div
        className={`lg:px-10 lg:py-3 pb-25 px-5 ${isFooterOpen ? "block" : "hidden"} md:block `}
      >
        <footer className="grid lg:grid-cols-[35%_65%] grid-cols-1 m-auto gap-4">
          <div>
          ...
          <div>
            <div className="font-bold ">
              Categories{" "}
              <span className="text-green-600 ml-3 font-light">see all</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 justify-center items-center text-center my-10">
          ...
          <div className="flex md:gap-7 justify-center items-center mt-5 gap-3">
            <FaFacebook className="text-3xl" />
            <FaSquareXTwitter className="text-3xl" />
            <AiFillInstagram className="text-3xl" />
            <FaLinkedin className="text-3xl" />
            <BsFillThreadsFill className="text-3xl" />
          </div>
        </div>
        <div className="text-[14px] text-gray">
          “Blinkit” is owned & managed by &quot;Blink Commerce Private
          Limited&quot; and is not related, linked or interconnected in
          whatsoever manner or nature, to “GROFFR.COM” which is a real estate
          services business operated by “Redstone Consultancy Services Private
          Limited”.
        </div>
      </div>
    </>
